...
ActiveRecord::Schema[7.1].define(version: 20_260_508_162_945) do
  ...
  create_table 'task_occurrences', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[task_id date], name: 'index_task_occurrences_on_task_id_and_date', unique: true
  ...
  create_table 'task_tags', force: :cascade do |t|
    ...
    t.index %w[task_id tag_id], name: 'index_task_tags_on_task_id_and_tag_id', unique: true
